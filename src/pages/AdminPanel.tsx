...
export default function AdminPanel() {
  ...
  if (!isAuthorized) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 via-purple-50 to-pink-50 dark:from-background dark:via-background dark:to-background">
        <Card className="max-w-md w-full mx-4 shadow-2xl border-2">
          <CardContent className="pt-8 pb-8 text-center">
            <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-rose-400 to-purple-500 rounded-full flex items-center justify-center animate-pulse">
              <Lock className="w-10 h-10 text-white" />
            </div>
            <h3 className="text-2xl font-bold mb-3 bg-gradient-to-r from-rose-600 to-purple-600 bg-clip-text text-transparent">
              Access Denied
            </h3>
            <p className="text-muted-foreground">You need admin privileges to view this magical panel.</p>
          </CardContent>
        </Card>
      </div>
    );
