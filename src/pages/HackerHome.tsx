    ...
    <div className="page-shell">
      <div className="page-content space-y-8">
            ...
            {quickActions.map((action) => {
              ...
              return (
                <button
                  ...
                  className="card-luxury text-left"
                >
                  <div className={`feature-icon ${action.color} mb-3`}>
        ...
        <section className="animate-in-delay-3">
          <div className="section-header">
            <h2 className="section-title">Discover Yourself</h2>
            <button 
          ...
          <div className="card-highlight">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-headline text-foreground mb-1">
                  Plan Your Date
                </h3>
                <p className="text-body text-sm">
                  Explore 70+ handpicked spots in OKC
                </p>
              </div>
            </div>
            <button
